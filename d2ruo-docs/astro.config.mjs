  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: ' 4. 🗺️ Region & Monster Tracking [NEW]', link: '#h3-en-17', attrs: { class: 'en-menu h3-item' } },
        { label: ' 5. ⏱️ Speedrun Timer', link: '#h3-en-18', attrs: { class: 'en-menu h3-item' } },
        { label: ' 6. 📷 Gear & Skill Build Snapshot Manager [NEW]', link: '#h3-en-19', attrs: { class: 'en-menu h3-item' } },
        { label: ' 7. 📺 OBS Studio Streaming Support & UI Convenience [NEW]', link: '#h3-en-20', attrs: { class: 'en-menu h3-item' } },
