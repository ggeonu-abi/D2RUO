  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: ' 7. 📋 릴레이 방제 자동 캡처 & 복사', link: '#h3-ko-9', attrs: { class: 'ko-menu h3-item' } },
        { label: ' 8. 📺 방송 송출', link: '#h3-ko-10', attrs: { class: 'ko-menu h3-item' } },
        ...
        { label: ' 💡 버그 신고 및 기능 제안', link: '#h3-ko-11', attrs: { class: 'ko-menu h3-item' } },
        { label: ' ☕ 후원하기', link: '#h3-ko-12', attrs: { class: 'ko-menu h3-item' } },
        ...
        { label: ' 1. 😈 Real-time TZ & DClone Tracker', link: '#h3-en-15', attrs: { class: 'en-menu h3-item' } },
        { label: ' 2. 📖 In-game Item Search Dictionary', link: '#h3-en-16', attrs: { class: 'en-menu h3-item' } },
        { label: ' 3. 🛡️ Powerful Buff Overlay', link: '#h3-en-17', attrs: { class: 'en-menu h3-item' } },
        { label: ' 4. 🗺️ Region & Monster Tracking', link: '#h3-en-18', attrs: { class: 'en-menu h3-item' } },
        { label: ' 5. ⏱️ Speedrun Timer', link: '#h3-en-19', attrs: { class: 'en-menu h3-item' } },
        { label: ' 6. 📷 Gear & Skill Build Snapshot Manager', link: '#h3-en-20', attrs: { class: 'en-menu h3-item' } },
        { label: ' 7. 📋 Relay Game Name OCR Capture & Copy', link: '#h3-en-21', attrs: { class: 'en-menu h3-item' } },
        { label: ' 8. 📺 OBS Studio Streaming Support & UI Convenience', link: '#h3-en-22', attrs: { class: 'en-menu h3-item' } },
        ...
        { label: ' 💡 Bug Reports & Feature Requests', link: '#h3-en-23', attrs: { class: 'en-menu h3-item' } },
        { label: ' ☕ Support', link: '#h3-en-24', attrs: { class: 'en-menu h3-item' } }
      ],
      // --- AUTO-SIDEBAR-END ---
    }),
  ],
