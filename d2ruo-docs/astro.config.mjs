  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: ' 1. Next Terror Zone & DClone Progress', link: '#h3-en-15', attrs: { class: 'en-menu h3-item' } },
        { label: ' 2. Buff Overlay & Profile Management', link: '#h3-en-16', attrs: { class: 'en-menu h3-item' } },
        { label: ' 3. Real-time Item Search Dictionary', link: '#h3-en-17', attrs: { class: 'en-menu h3-item' } },
        { label: ' 4. Speedrun Timer', link: '#h3-en-18', attrs: { class: 'en-menu h3-item' } },
        { label: '🚀 Getting Started', link: '#getting-started-en', attrs: { class: 'en-menu' } },
        { label: ' 1. Download & Preparation', link: '#h3-en-19', attrs: { class: 'en-menu h3-item' } },
        { label: ' 2. Run & Configure', link: '#h3-en-20', attrs: { class: 'en-menu h3-item' } },
        { label: '⌨️ Hotkeys', link: '#hotkeys-en', attrs: { class: 'en-menu' } },
        { label: '✨ Key Features', link: '#features-en', attrs: { class: 'en-menu' } },
        { label: ' 1. 😈 Real-time TZ & DClone Tracker', link: '#h3-en-21', attrs: { class: 'en-menu h3-item' } },
        { label: ' 2. 📖 In-game Item Search Dictionary', link: '#h3-en-22', attrs: { class: 'en-menu h3-item' } },
        { label: ' 3. 🛡️ Powerful Buff Overlay', link: '#h3-en-23', attrs: { class: 'en-menu h3-item' } },
        { label: ' 4. 🗺️ Region & Monster Tracking [NEW]', link: '#h3-en-24', attrs: { class: 'en-menu h3-item' } },
        { label: ' 5. ⏱️ Speedrun Timer', link: '#h3-en-25', attrs: { class: 'en-menu h3-item' } },
